  ...
  render: ->
    ...
    if packageBookCount > 0 || true
      ...
      if @state.packagePickupAddressType == 'dorm'
          ...
          `<div className="row dorm-address">
            ...
            <div className="col m4 s12">
              <select className="browser-default" onChange={this.handlePackagePickupAddressDormNumChange} value={this.state.packagePickupAddressDormNum}>
                ...
                <option value="光復二宿">光復二宿</option>
                <option value="敬業一宿">敬業一宿</option>
                <option value="勝利一宿">勝利一宿</option>
                <option value="勝利二宿">勝利二宿</option>
                <option value="勝利三宿">勝利三宿</option>
                <option value="勝利八宿">勝利八宿</option>
                <option value="勝利九宿">勝利九宿</option>
                <option value="翠亨Ｂ棟">翠亨Ｂ棟</option>
                <option value="武嶺二村">武嶺二村</option>
                <option value="翠亨Ｃ棟">翠亨Ｃ棟</option>
                <option value="國-際-村">國-際-村</option>
                <option value="翠亨Ｈ棟">翠亨Ｈ棟</option>
                <option value="翠亨Ｌ棟">翠亨Ｌ棟</option>
                <option value="翠亨Ｅ棟">翠亨Ｅ棟</option>
                <option value="翠亨Ａ棟">翠亨Ａ棟</option>
                <option value="武嶺三村">武嶺三村</option>
                <option value="翠亨Ｆ棟">翠亨Ｆ棟</option>
                <option value="翠亨Ｇ棟">翠亨Ｇ棟</option>
                <option value="翠亨Ｄ棟">翠亨Ｄ棟</option>
        ...
        packagePickupAddressInput =
          `<div className="row">
            <div style={{ paddingTop: '12px' }}>僅限敦煌書局合作學校（中央、中興、元智、輔大）使用 (最慢五天可送達)。</div>
